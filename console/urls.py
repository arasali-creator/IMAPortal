...
urlpatterns = [
    ...
    path("upwork/", views.upwork_tracking, name="upwork_tracking"),
    path("upwork/entries/new/", views.upwork_entry_create, name="upwork_entry_create"),
    path("upwork/entries/<int:pk>/edit/", views.upwork_entry_edit, name="upwork_entry_edit"),
    path("upwork/entries/<int:pk>/delete/", views.upwork_entry_delete, name="upwork_entry_delete"),
    path("upwork/profiles/", views.upwork_profiles, name="upwork_profiles"),
